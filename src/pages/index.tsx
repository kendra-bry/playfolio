      ...
      <div className="text-white">
        ...
        <Section className="md:min-h-64 lg:h-64 px-10 md:px-48 lg:px-64 bg-secondary">
          <h2 className="text-2xl text-center mb-4">
            Rate, Comment, and Track
          </h2>
          <p className="text-lg text-center">
            Make each game uniquely yours by adding ratings, start and stop
            dates, and personal comments. Share your thoughts with the community
            and keep track of your gaming journey.
          </p>
        </Section>
        ...
        <Section className="md:min-h-64 lg:h-64 px-10 md:px-48 lg:px-64">
          ...
          <p className="text-lg text-center">
            ...
            culture. Join us on this thrilling adventure and unleash the power
            of play! Your next gaming story begins here.
          </p>
        </Section>
      </div>
    </>
